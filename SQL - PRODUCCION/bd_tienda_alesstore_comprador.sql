...
CREATE TABLE `comprador` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK5o2vykaikodgl8rsmnq6iqjjc` (`distrito_id`),
  KEY `FKrm457msoffsrhxne19c4p6lea` (`producto_id`),
  CONSTRAINT `FK5o2vykaikodgl8rsmnq6iqjjc` FOREIGN KEY (`distrito_id`) REFERENCES `ubicacion` (`id`),
  CONSTRAINT `FKrm457msoffsrhxne19c4p6lea` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id_dpc`)
